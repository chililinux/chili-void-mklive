...
const NUMBER_RETRIEVE_SCRIPT = "https://jitsi-api.jitsi.net/phoneNumberList?calendar=true";
const CONFERENCE_MAPPER_SCRIPT = "https://jitsi-api.jitsi.net/conferenceMapper";
...
class EventContainer {
     ...
     */
    isButtonPresent() {
        return ($('#jitsi-meet_button').length >= 1);
    }
...
class Description {
    ...
    updateInitialButtonURL(location) {
        var button = $('#jitsi-meet_button a');
...
class G2Event extends EventContainer {
    ...
    get buttonContainer() {
        ...
        let buttonContainer = $('#jitsi-meet_button_container');
                ...
                <div class = "j3nyw">\
                    <div class = "BY5aAd">\
                        <div role = "button" \
                            ...
                            id="jitsi-meet_button_container">\
                            <content class = "CwaK9">\
                                <span id="jitsi-meet_button" \
                                      class="RveJvd snByac">\
                                </span>\
                            </content>\
                        </div>\
            ...
            if (quickAddDialog.length >= 1) {
                ...
                setTimeout(function () {
                    ...
                    if(quickAddDialogContainer.length < 1
                        || $('#jitsi-meet_button_quick_add').length != 0) {
                        return;
                    }
                        ...
                        '<div class="split-tile-right" style="float:left">' +
                            '<div class="tile-content" ' +
                                ...
                                '<div class="right-actions" ' +
                                    ...
                                    '<div id="jitsi-meet_button_quick_add" ' +
            ...
            if (document.querySelector('body').dataset.viewfamily === 'EVENT') {
                mutations.forEach(function (mutation) {
                    ...
                    if (newElement
                        ...
                        // skip if our button is already added
                        if ($('#jitsi-meet_button_quick_add').length != 0) {
                            return;
                        }
                        ...
                        if (tabEvent.length > 0) {
                            var jitsiQuickAddButton = $(
                                '<content class="" role="tabpanel" id="jitsi-meet_button_quick_add_content"> \
                                    <div class="fy8IH poWrGb">\
                                        ...
                                        <div class="mH89We">\
                                            <div role="button" \
                                                 class="uArJ5e UQuaGc Y5sE8d" \
                                                 id="jitsi-meet_button_quick_add">\
                                                <content class="CwaK9">\
